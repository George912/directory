...
DROP INDEX IF EXISTS contact_id_idx;
...
-- drop indexes for table users_groups
DROP INDEX IF EXISTS ug_user_id_idx;
DROP INDEX IF EXISTS ug_group_id_idx;

-- drop indexes for table users_contacts
DROP INDEX IF EXISTS uc_user_id_idx;
DROP INDEX IF EXISTS uc_contact_id_idx;
